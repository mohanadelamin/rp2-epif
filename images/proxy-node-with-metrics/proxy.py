...
class MetricGatherer:
    ...
    def update_http_requests(self, offset=1):
        self.metrics["number_of_requests"] += offset
    ...
    def __transfer(self, socket1, socket2):
        while self.__running:
            try:
                ...
                # Update request every time the socket is used
                metricGatherer.update_http_requests()
